...
from ui_Right_ToolBar import  Ui_Right_ToolBar
...
#1# ==========自定义功能函数=========================================
    ...
    def appear(self,int_x,int_y):
        ...
        animation.setStartValue(QPoint(int_x+440-self.geometry().width(),int_y+82))
    ...
    def fade(self):
        ...
        animation.setEndValue(QPoint(self.pos().x()-self.geometry().width(),self.pos().y()))
        animation.setDuration(550)
        animation.setEasingCurve(QEasingCurve.OutBounce)
        animation.start()
        #准备后事
